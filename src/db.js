...
const databaseUrl = cleanEnv(env.VITE_DATABASE_URL || env.DATABASE_URL)
const databaseAuthToken = cleanEnv(env.VITE_DATABASE_AUTH_TOKEN || env.DATABASE_AUTH_TOKEN)
